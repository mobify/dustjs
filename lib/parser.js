  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "comp_tag_start": parse_comp_tag_start,
      ...
      function parse_component() {
        ...
        reportFailures--;
        if (reportFailures === 0 && result0 === null) {
          matchFailed("component");
        }
        return result0;
      }
      
      function parse_comp_tag_start() {
        var result0, result1, result2, result3, result4;
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result3 = (function(offset, line, column, i) {return i})(pos2.offset, pos2.line, pos2.column, result3[1]);
              }
              if (result3 === null) {
                pos = clone(pos2);
              }
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, t, n, f, p) { return [t, n, f, p] })(pos0.offset, pos0.line, pos0.column, result0[1], result0[2], result0[3], result0[4]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
