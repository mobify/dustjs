  ...
  var result = {
    ...
    parse: function(input, startRule) {
      var parseFunctions = {
        ...
        "inc_tag_start": parse_inc_tag_start,
      ...
      function parse_include() {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                ...
                if (result4 !== null) {
                  ...
                  result5 = result5 !== null ? result5 : "";
                  if (result5 !== null) {
                    result6 = (function(offset, line, column, t, b, e, z) { if ((!z) || (t[0] !== z.text)) {throw new Error("Expected end tag for "+t[0]+" but it was not found. At line : "+line+", column : " + column)} return true; })(pos.offset, pos.line, pos.column, result0, result3, result4, result5) ? "" : null;
                    if (result6 !== null) {
                      result0 = [result0, result1, result2, result3, result4, result5, result6];
                    } else {
                      result0 = null;
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, t, b, e, z) {
              t[0] = "include";
              e.push(["param", ["literal", "block"], b]);
              t.push(e);
              return t.concat([['line', line], ['col', column]])
            })(pos0.offset, pos0.line, pos0.column, result0[0], result0[3], result0[4], result0[5]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_inc_tag_start() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, t, n, c, p) {
              if (c.length < 2) {c.push(["literal", {}]); c.concat([['line', line], ['col', column]])};
              return ["include", n, c, p]
            })(pos0.offset, pos0.line, pos0.column, result0[1], result0[3], result0[4], result0[5]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
